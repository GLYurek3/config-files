...
#else
static const char *fonts[]               = { "FiraCode-Retina:pixelsize=17:antialias=true:autohint=true" };
#endif // BAR_PANGO_PATCH
static const char dmenufont[]            = "FiraCode-Retina:pixelsize=17:antialias=true:autohint=true";
...
static const char *ply[]      = { "mpc", "--port", "6666", "toggle", NULL         };
static const char *nxttrk[]   = { "mpc", "--port", "6666", "next", NULL           };
static const char *prvtrk[]   = { "mpc", "--port", "6666", "prev", NULL           };
static const char *mpdvu[]    = { "mpc", "--port", "6666", "volume", "+2", NULL   };
static const char *mpdvd[]    = { "mpc", "--port", "6666", "volume", "-2", NULL   };
static const char *brightup[] = { "xbacklight", "-inc", "2", NULL                 };
static const char *brightdn[] = { "xbacklight", "-dec", "2", NULL                 };
static const char *scrnsht[]  = { "scrot", "-s", "select", NULL                   };
static const char *zath[]    =  { "zathura", NULL                                 };
static Key keys[] = {
	/* modifier                     key            function                argument */
    ...
    { MODKEY|ShiftMask,             XK_z,                     spawn,          {.v = zath     } },
	#if KEYMODES_PATCH
